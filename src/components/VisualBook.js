...
const VisualBook = ({title, price, link, image, VisualTopic}) => {
  // console.log(VisualTopic);
  return (
    <div className="bg-[--main-color]  my-12">
      <div className="flex flex-wrap justify-evenly text-white p-8">
        ...
        <div className="text-center flex flex-col mt-6 items-center justify-center">
          <img src={`https://a4medicine-charts.s3.ap-southeast-2.amazonaws.com/${image}`} alt="" className="h-96" />
